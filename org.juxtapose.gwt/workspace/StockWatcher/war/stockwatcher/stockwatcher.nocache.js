function stockwatcher(){
  ...
  function installScript(filename){
    ...
    stockwatcher.onScriptDownloaded = function(code){
  ...
  ;
  stockwatcher.__installRunAsyncCode = function(code){
    var docbody = getInstallLocation();
  ...
  function getCompiledCodeFilename(){
    ...
    var strongName;
    try {
      unflattenKeylistIntoAnswers(['safari'], '2589C8E7D399DC6A315B3B7093750757');
      unflattenKeylistIntoAnswers(['ie9'], '5F5C6D38961980FB4EFEBBBAFAF8AC30');
      unflattenKeylistIntoAnswers(['ie8'], '951C5D8D4ABAD7F6C5A3A6B5FB2C054E');
      unflattenKeylistIntoAnswers(['ie6'], 'A7E687637C0F96AA451A1C96B506AA33');
      unflattenKeylistIntoAnswers(['gecko1_8'], 'DE4D35DD3D1171728D10B03B8D6B7D0E');
      unflattenKeylistIntoAnswers(['opera'], 'F7C9770FBB052E58F45536782391E357');
  ...
  if ($wnd_0) {
    $wnd_0.__gwt_activeModules['stockwatcher'].canRedirect = true;
  }
