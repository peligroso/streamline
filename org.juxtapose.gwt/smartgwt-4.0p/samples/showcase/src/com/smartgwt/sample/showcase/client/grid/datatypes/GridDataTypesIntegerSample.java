...
public class GridDataTypesIntegerSample extends ShowcasePanel {
    private static final String DESCRIPTION = "Click on column headers to sort, or data values to" +
                                              " edit. \"Population\" is an integer field.";

    public static class Factory implements PanelFactory {
        private String id;

        public Canvas create() {
            GridDataTypesIntegerSample panel = new GridDataTypesIntegerSample();
            id = panel.getID();
            return panel;
        }
