...
public class MarketData extends DataProducerService implements IMarketDataService
{
	...
	public void getDataKey( ISTMEntryRequestSubscriber inSubscriber, Object inTag, Map<String, String> inQuery )
	{
		...
		if( MarketDataConstants.STATE_TYPE_INSTRUMENT.equals( type ) )
		{
			...
			ISTMEntryKey key = createEntryKey( getServiceId(), MarketDataConstants.STATE_TYPE_INSTRUMENT, new String[]{MarketDataConstants.FIELD_SOURCE, FXDataConstants.FIELD_CCY1, FXDataConstants.FIELD_CCY2, FXDataConstants.FIELD_PERIOD},new String[]{source, ccy1, ccy2, period} );
